...
public class MailSender {
     public static void sendMail(String mail) throws Exception {
        String mailContent = "<!DOCTYPE html>\n"
                ...
                + "																			style=\"margin: 0; font-size: 14px; text-align: center;\">\n"
                + "																			<span\n"
                + "																				style=\"font-size:18px;color:#000000;\"><br>Details:<br> Company name : "+"ALLKIFF"+"</span>\n"
                + "																		</p>\n"
                + "																		<p\n"
                + "																			style=\"margin: 0; font-size: 14px; text-align: center;\">\n"
                + "																			<span\n"
                ...
                + "																		<p\n"
                + "																			style=\"margin: 0; font-size: 14px; text-align: center;\">\n"
                + "																			ALLKIFF © -  Your favorite company tool.\n"
                + "																		</p>\n"
                + "																		<p\n"
                + "																			style=\"margin: 0; font-size: 14px; text-align: center;\">\n"
                + "																			Tunis, Tunisia.</p>\n"
    ...
    private static Message prepareMessage(Session session, String myAccountEmail, String recipient , String mailContent) {
        try {
            ...
            message.setSubject("Welcome to ALLKIFF");
